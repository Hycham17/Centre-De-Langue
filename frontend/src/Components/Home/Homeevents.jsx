    ...
    return (
        events&&  <section className="flex  flex-col  px-5  gap-y-6 ">
            ...
            <div className="flex my-10 justify-center items-center">
              <Link to='/events' className="w-full flex justify-center items-center">
              <button
                    className="w-full sm:w-[50%]  h-11 font-B bg-blueColor transition-all  hover:opacity-[0.6] text-white  md:w-[30%] rounded "
                >
